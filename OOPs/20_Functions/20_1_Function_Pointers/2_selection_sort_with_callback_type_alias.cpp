...
using ComparisonFunction = bool(*)(const int&, const int&); 
...
void selectionSort(int *arr, int size, ComparisonFunction comparison = ascending_order)
{
    if(!arr || !comparison)
        return;
