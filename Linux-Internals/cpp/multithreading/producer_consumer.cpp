 ...
 * Producer adds tasks to queue, consumers remove and process
 * Requires: mutex (protect queue), condition_variable (signal/wait)
 * Key interview pattern - demonstrates thread coordination
 * Components: shared queue, mutex, cv for empty condition
 */
