/* SINGLE WORKER THREAD - Basic std::thread usage
 * Creates one background worker thread while main continues
 * join(): Main waits for worker to finish before exiting
 * Foundation for understanding multi-threading
 * Interview: Basic thread creation and join pattern
 */
