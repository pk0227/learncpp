/* RACE CONDITION - Another demonstration of data race
 * Unsynchronized access to shared variable from multiple threads
 * Shows non-deterministic behavior (different results each run)
 * Interview: Explain what makes this a race and how to fix
 */
