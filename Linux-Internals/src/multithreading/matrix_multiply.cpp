 ...
 * Distributes matrix rows across threads for parallel computation
 * Classic parallel algorithm: each thread computes subset of result
 * Interview: Explain work distribution, speedup vs overhead
 * Shows how to parallelize CPU-bound workloads
 */
