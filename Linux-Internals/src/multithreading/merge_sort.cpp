 ...
 * Recursively splits array, sorts halves in parallel threads
 * Demonstrates parallel algorithms pattern
 * Interview: Explain recursion depth limit (avoid too many threads)
 * Compare: std::async vs std::thread for this pattern
 */
