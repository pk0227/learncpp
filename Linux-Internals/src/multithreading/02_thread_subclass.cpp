...
#include <functional>
#include <iostream>
/* THREAD WITH CALLABLE OBJECT
 * Demonstrates passing function object/lambda to thread
 * Alternative to function pointers: more flexible, can capture state
 * Interview: Know multiple ways to start threads (function, lambda, functor)
 */
