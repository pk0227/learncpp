/* PARALLEL DOWNLOADS - I/O-bound parallelism
 * Downloads multiple files concurrently using threads
 * Perfect use case for multithreading: I/O-bound operations
 * Much faster than sequential downloads (network latency)
 * Interview: I/O-bound vs CPU-bound parallelism
 */
